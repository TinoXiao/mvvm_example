...
object DateUtil {
    ...
    const val YEARMONTHDAY = "yyyyMMdd"
    ...
    fun change(date:String):String{
        var simpleDateFormat = SimpleDateFormat(YEARMONTHDAY)
        val date = simpleDateFormat.parse(date)
        simpleDateFormat = SimpleDateFormat(YEAR_MONTH_DAY)
